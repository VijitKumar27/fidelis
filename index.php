      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          ...
          <li><a class="scroll" href="#logo"></a></li>
            ...
            <li><a class="analyse" href="#analyse">Analyse your area</a></li>
...
<!-- This is the analyse location point -->
<section id="analyse">
  <div class="container">
    <div class="col-md-8 col-md-offset-2">
      <div class="heading">
        <h2>Analyse <span>MY AREA</span></h2>
        <div class="line"></div>
        <p><span><strong></strong></span></p>
        <p><span><strong></strong></span>Let's you know about the crime records in that area</p>
      </div>
    </div>
    <div class="row">
      <div class="col-md-12 ab-sec">
        <div class="col-md-6">
          <h3 class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms"><span>Use </span>your location</h3>
          <p><span><strong>Don't</strong></span> be late, otherwise it will be tooo late!!!</p>
         <a href = locateme.php>
          <button id = "btn_loc" style="background-color:black; color: white; font-size: 24px" href="locateme.php">Check now</button>
</a></div>
        <div class="col-md-6 ab-sec-img wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms"><img src="images/Analyse/1.png" alt="" width = 100px> </div>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="col-md-8 col-md-offset-2">
      <div class="heading">
        ...
        <div class="line"></div>
        <p><span><strong>CRIMINOLOGY</strong></span></p>
        <p><span><strong></strong></span>We aim to collect & analyse the crime statistics in a particular region for your safety.</p>
      </div>
    </div>
    <div class="row">
      <div class="col-md-12 ab-sec">
        <div class="col-md-6">
          <h3 class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms"><span>SAFER INDIA, </span>BETTER INDIA</h3>
          <p><span><strong></strong></span>We work towards ensuring a safer world for the humanking to exist with peace and harmony, free from all fear of crime. Enjoy your life. LIFE IS BEAUTIFUL!</p>
        </div>
...
<div class="bg-sec">
  <div class="container">
    ...
    <div class="col-md-2 col-sm-8 col-xs-4"> <a class="btn-down" href="#">Helpline</a> </div>
  </div>
</div>
  ...
  <div class="container">
    <div class="col-md-8 col-md-offset-2">
      <div class="heading">
        ...
        <div class="line"></div>
        <p><span><strong></strong></span>We strive to give you the best we can.</p>
      </div>
    </div>
        ...
        <div class="col-md-4 col-sm-6 col-xs-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="100ms">
          <div class="media service-box">
            ...
            <div class="media-body">
              <h5 class="media-heading">Statistical Analysis</h5>
              <p>We observe & analyse the data to make calculative inferences for better deployemnt & utilisation of resources.</p>
            </div>
          </div>
        </div>
        <!--/.col-md-4-->
        <div class="col-md-4 col-sm-6 col-xs-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="200ms">
          <div class="media service-box">
            ...
            <div class="media-body">
              <h5 class="media-heading">Suggestions</h5>
              <p>Based on extensive data analysis, make smart & practical resource mapping to aid in efficient crime management.</p>
            </div>
          </div>
        </div>
        <!--/.col-md-4-->
        <div class="col-md-4 col-sm-6 col-xs-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="300ms">
          <div class="media service-box">
            ...
            <div class="media-body">
              <h5 class="media-heading">Job-listings</h5>
              <p>Ex-convicts are barely given an oppurtunity to get back into a profession. We will assist in providing potential job prospects.</p>
            </div>
          </div>
        </div>
        <!--/.col-md-4-->
  ...
  <div class="container">
    <div class="col-md-8 col-md-offset-2">
      <div class="heading">
        ...
        <div class="line"></div>
        <p><span><strong>We are in it together.</strong></span></p>
      </div>
    </div>
    <div class="row">
      <div class="col-md-3 col-sm-6 col-xs-12 team-main-sec wow slideInUp" data-wow-duration="1s" data-wow-delay=".1s">
        <div class="team-sec">
          <div class="team-img"> <img src="images/Team/1.jfif" class="img-responsive" alt="">
            <div class="team-desc">
              <h5>Vijit Kumar</h5>
              <p>Front-End</p>
      ...
      <div class="col-md-3 col-sm-6 col-xs-12 team-main-sec wow slideInUp" data-wow-duration="1s" data-wow-delay=".2s">
        <div class="team-sec">
          <div class="team-img"> <img src="images/Team/2.jpg" class="img-responsive" alt="">
            <div class="team-desc">
              <h5>Vibha Murthy</h5>
              <p>Front-End</p>
              <ul class="team-social-icon">
      ...
      <div class="col-md-3 col-sm-6 col-xs-12 team-main-sec wow slideInUp" data-wow-duration="1s" data-wow-delay=".3s">
        <div class="team-sec">
          <div class="team-img"> <img src="images/Team/3.jfif" class="img-responsive" alt="">
            <div class="team-desc">
              <h5>V Himadhith</h5>
              <p>Back-End</p>
              <ul class="team-social-icon">
      ...
      <div class="col-md-3 col-sm-6 col-xs-12 team-main-sec wow slideInUp" data-wow-duration="1s" data-wow-delay=".4s">
        <div class="team-sec">
          <div class="team-img"> <img src="images/Team/4.jfif" class="img-responsive" alt="">
            <div class="team-desc">
              <h5>Utkarsh Bagaria</h5>
              <p>Back-End</p>
              <ul class="team-social-icon">
                <li><a href="#" data-toggle="tooltip" data-placement="top" title="Facebook"><i class="fa fa-facebook-f"></i></a></li>
                <li><a href="#" data-toggle="tooltip" data-placement="top" title="Twitter"><i class="fa fa-twitter"></i></a></li>
      ...
      <div id="owl-testi" class="owl-carousel owl-theme">
        <div class="item">
          <div  class="col-md-10 col-md-offset-1"> <img src="images/Testimonials/02.jpg" class="img-circle" alt="">
            <h5>A really useful tool & the police department has benefitted largely from it</h5>
            <h6>Prithviraj Chauhan</h6>
            <p>Superintendent of Police</p>
          </div>
        </div>
        <div  class="col-md-10 col-md-offset-1"> <img src="images/Testimonials/03.jpg" class="img-circle" alt="">
          <h5>This was the need of the hour of the general public. Really useful!</h5>
          <h6>Aarav Singhania</h6>
          <p>Software Engineer</p>
        </div>
        <div  class="col-md-10 col-md-offset-1"> <img src="images/Testimonials/04.jpg" class="img-circle" alt="">
          <h5>My life has got a second-chance. I am really happy.</h5>
          <h6>Samaira Sheikh</h6>
          <p>Ex-convict</p>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-sm-6 col-md-3">
        <div class="fun-fact text-center">
          <h3><i class="fa fa-thumbs-o-up"></i> <span class="timer">4286</span></h3>
          <h6>Happy Users</h6>
        </div>
      </div>
      <div class="col-sm-6 col-md-3">
      ...
      <div class="col-sm-6 col-md-3">
        <div class="fun-fact text-center">
          <h3><i class="fa fa-coffee"></i> <span class="timer">256</span></h3>
          <h6>Jobs provided</h6>
        </div>
      </div>
      <div class="col-sm-6 col-md-3">
        <div class="fun-fact text-center">
          <h3><i class="fa fa-code"></i> <span class="timer">9236</span></h3>
...
<footer id="footer">
  <div class="bg-sec">
    <div class="container">
      <h2>LOOKING FORWARD TO <strong>KEEPING </strong>YOU SAFE!</h2>
    </div>
  </div>
</footer>
<footer id="footer-down">
  ...
  <p> &copy; Copyright 2021 FIDELIS - Created By : Team Catalunya</a> </p>
</footer>
<!--Jquery-->
